...
TB_GOSB_CODES = {
    'tb_codes': {
        ...
        100: {'full_name': 'Подразделения центрального подчинения', 'short_name': 'ПЦП'},
        101: {'full_name': 'Сбер Факторинг', 'short_name': 'Сбер Факторинг'},
        102: {'full_name': 'Сбербанк Лизинг', 'short_name': 'Сбербанк Лизинг'},
